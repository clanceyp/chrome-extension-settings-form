...
OPTIONS.FORMS = {
	"options" : [
		...
		{"name":"test-text-one", "label":"Text", "type":"text", parent:'basicSettings', attr:{placeholder: "some text"}},
		...
		{"name":"test-range", "label":"Range", "type":"text", "html5":"range",  parent:'advancedSettings',value:100,attr:{"min":5,"max":120,"step":5},data:{"suffix":" mins"}},
